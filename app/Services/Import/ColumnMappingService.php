...
PROMPT;
    ...
    private function aliases(string $field): array
    {
        return [
            ...
            'region'         => ['region', 'region_name', 'state', 'province', 'territory'],
            'area'           => ['area', 'area_name', 'district', 'sub_region', 'subregion'],
            ...
            'role'           => ['role', 'user_role', 'access_level', 'permission', 'access', 'type', 'job_role', 'position', 'job_title'],
            'language'       => ['language', 'lang', 'locale', 'preferred_language', 'working_language'],
            'manages'        => ['manages', 'managed_regions', 'managed_areas', 'manages_regions', 'manages_areas', 'responsible_for', 'area_managed', 'region_managed'],
            'geofence_radius_m' => ['geofence_radius_m', 'geofence_radius', 'geofence', 'onsite_radius', 'on_site_radius', 'radius_m'],
