 ...
 * and they resurface automatically if they worsen past the floor on a later run.
 *
...
class TidyQueueTailCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        foreach ($tenants as $tenant) {
            ...
            $totalSnoozed += $count;
            $this->info("Tenant {$tenant->id} ({$tenant->name}): snoozed {$count} low-value trend items for {$days}d.");
        }
