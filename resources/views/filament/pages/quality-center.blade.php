<x-filament-panels::page>
    ...
    <style>
        ...
        .qc-tile { background:var(--ax-bg); border:1px solid var(--ax-line); border-radius:.75rem; padding:1rem; box-shadow:var(--ax-shadow); }
        .qc-tile .lbl { font-size:.7rem; text-transform:uppercase; letter-spacing:.05em; color:var(--ax-muted); }
        .qc-tile .val { font-size:1.6rem; font-weight:800; color:var(--ax-ink); margin-top:.2rem; }
        .qc-card { background:var(--ax-bg); border:1px solid var(--ax-line); border-radius:.875rem; box-shadow:var(--ax-shadow); overflow:hidden; }
        .qc-card h3 { font-size:.9rem; font-weight:700; color:var(--ax-ink); padding:.85rem 1.15rem; border-bottom:1px solid var(--ax-line-2); margin:0; }
        .qc-card .body { padding:1rem 1.15rem; }
        .qc-funnel-row { display:flex; align-items:center; gap:.75rem; margin-bottom:.5rem; }
        .qc-funnel-row .name { width:170px; font-size:.78rem; color:var(--ax-text); }
        .qc-funnel-bar { flex:1; background:var(--ax-neutral-soft); border-radius:9999px; height:20px; overflow:hidden; }
        .qc-funnel-bar > span { display:block; height:100%; background:linear-gradient(90deg,var(--ax-accent-600),var(--ax-accent-400)); }
        .qc-funnel-row .cnt { width:60px; text-align:right; font-weight:700; font-size:.8rem; color:var(--ax-ink); }
        table.qc-tbl { width:100%; border-collapse:collapse; font-size:.78rem; }
        table.qc-tbl th { text-align:left; color:var(--ax-muted); font-size:.68rem; text-transform:uppercase; padding:.4rem .6rem; border-bottom:1px solid var(--ax-line); }
        table.qc-tbl td { padding:.45rem .6rem; border-bottom:1px solid var(--ax-line-2); color:var(--ax-text); }
        .qc-muted { color:var(--ax-muted); font-size:.8rem; }
        .qc-flag { background:var(--ax-warning-soft); color:var(--ax-warning-fg); padding:.15rem .5rem; border-radius:9999px; font-size:.68rem; font-weight:700; }
    </style>
    ...
    <div class="qc-wrap">
            ...
            <div class="body">
                @if($score && ($score['available'] ?? false))
                    <div style="display:flex; align-items:baseline; gap:.75rem;">
                        <span style="font-size:2rem; font-weight:800; color:var(--ax-ink);">{{ $score['score'] }}</span>
        ...
        <div class="qc-grid" style="grid-template-columns:1fr;">
            ...
            <div class="qc-card">
                ...
                <div class="body qc-muted" style="border-top:1px solid var(--ax-line-2);">
