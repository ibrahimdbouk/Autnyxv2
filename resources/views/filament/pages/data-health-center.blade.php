<x-filament-panels::page>
    @php
        ...
        $statusColors = [
            'healthy'  => ['var(--ax-success-soft)', 'var(--ax-success-fg)', 'var(--ax-success)'],
            'warning'  => ['var(--ax-warning-soft)', 'var(--ax-warning-fg)', 'var(--ax-warning)'],
            'critical' => ['var(--ax-danger-soft)', 'var(--ax-danger-fg)', 'var(--ax-danger)'],
            'no_data'  => ['var(--ax-neutral-soft)', 'var(--ax-neutral-fg)', 'var(--ax-faint)'],
        ];
    ...
    <style>
        ...
        .dh-summary { display:flex; flex-wrap:wrap; align-items:center; gap:1.5rem; background:var(--ax-bg); border:1px solid var(--ax-line); border-radius:1rem; padding:1.5rem; box-shadow:var(--ax-shadow); }
        ...
        .dh-muted { color:var(--ax-muted); font-size:.8rem; }
        ...
        .dh-card { background:var(--ax-bg); border:1px solid var(--ax-line); border-radius:.875rem; box-shadow:var(--ax-shadow); overflow:hidden; }
        .dh-card-head { display:flex; align-items:center; justify-content:space-between; padding:.9rem 1.15rem; border-bottom:1px solid var(--ax-line-2); }
        .dh-card-title { font-weight:700; font-size:.95rem; color:var(--ax-ink); }
        ...
        .dh-row .k { color:var(--ax-muted); }
        .dh-row .v { color:var(--ax-ink); font-weight:600; }
        .dh-bar { height:6px; border-radius:9999px; background:var(--ax-neutral-soft); overflow:hidden; }
        ...
        <div class="dh-summary">
            <div style="display:flex; flex-direction:column; gap:.35rem;">
                <div class="dh-score" style="color:{{ $ov[1] }};">
                    {{ $overall['score'] !== null ? number_format($overall['score'], 0) : '—' }}<span style="font-size:1rem; color:var(--ax-faint);">/100</span>
                </div>
            ...
            <div style="flex:1; min-width:200px; display:flex; flex-direction:column; gap:.3rem;">
                <div style="font-weight:700; color:var(--ax-ink);">Overall data trust</div>
                <div class="dh-muted">
